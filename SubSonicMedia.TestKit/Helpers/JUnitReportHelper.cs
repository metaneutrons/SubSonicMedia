    ...
    public static class JUnitReportHelper
    {
            ...
            string outputDirectory)
        {
            try
            {
                ...
                testSuite.SetAttribute("timestamp", DateTime.UtcNow.ToString("yyyy-MM-ddTHH:mm:ss"));
                ...
                foreach (var (testName, result) in results)
                {
                    ...
                    switch (result)
                    {
                        case TestResult.Fail:
                            ...
                            if (testsByName.TryGetValue(testName, out var failedTest) && 
                        ...
                        case TestResult.Skipped:
                            ...
                            if (testsByName.TryGetValue(testName, out var skippedTest) && 
