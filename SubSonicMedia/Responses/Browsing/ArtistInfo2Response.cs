// <copyright file="ArtistInfo2Response.cs" company="Fabian Schmieder">
...
{
    /// <summary>
    /// Response containing artist info (version 2).
    /// </summary>
    public class ArtistInfo2Response : SubsonicResponse
    {
        /// <summary>
