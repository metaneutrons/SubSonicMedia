// <copyright file="MusicDirectoryResponse.cs" company="Fabian Schmieder">
...
{
    /// <summary>
    /// Response containing music directory contents.
    /// </summary>
    public class MusicDirectoryResponse : SubsonicResponse
    {
        /// <summary>
        /// Gets or sets the music directory.
        /// </summary>
        public MusicDirectory Directory { get; set; } = new MusicDirectory();
    }
